...
def _make_vit_b_rn50_backbone(
    ...
    for s in range(used_number_stages, 4):
        ...
        # unflatten_size = (size[0] // 16, size[1] // 16)
        # tensor = torch.zeros(batch_size, channels, unflatten_size[0], unflatten_size[1])
        # reshaped_tensor = tensor.view(batch_size, channels, unflatten_size[0], unflatten_size[1])
        # layers = [
        #     readout_oper[s],
        #     Transpose(1, 2),
        #     reshaped_tensor,
